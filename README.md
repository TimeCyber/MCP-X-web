...
### v0.1.2 优化更新
- **📚 文档全面升级**：平台定位更新为「企业级 AI 中台」，文档站新增视频生成指南，补充图生视频、参考图生视频、首尾帧插值、图生图、蒙版重绘等完整 API 文档，新增 Base URL 说明（`https://www.mcp-x.com/prod-api`）及模型列表接口文档。文档结构同步适配 **LobeChat（龙虾）**，让 LobeChat 可以直接读懂并接入 MCP-X 的全部能力
